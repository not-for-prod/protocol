...
const file_core_tron_proposal_proto_rawDesc = "" +
	"\n" +
	"\x18core/tron/proposal.protoB(B\rProposalProtoP\x01Z\x15protocol/pb/core/tron"

var file_core_tron_proposal_proto_goTypes = []any{}
...
func file_core_tron_proposal_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_core_tron_proposal_proto_rawDesc), len(file_core_tron_proposal_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
